...
import thefirstchange.example.com.communicationtext.util.ImageLoadOptions;
import thefirstchange.example.com.communicationtext.widget.CustomViewPager;
...
//        StatusBarCompat.setStatusBarColor(this,getResources().getColor(R.color.statustitle),false);
    ...
    protected void initViews() {
        ...
        layout_image=(LinearLayout)findViewById(R.id.brower_layout);
