package thefirstchange.example.com.communicationtext.course.supercouesrdemo2.widget;
...
public class WheelView extends View {
    ...
    private static  int DEFAULT_TEXT_COLOR_SELECTED = Color.parseColor("#00EE00");
    ...
    private static  int DEFAULT_DIVIDER_COLOR = 0XFFF56313;

    // default divider's height
    private static final int DEFAULT_DIVIDER_HEIGHT = 3;
