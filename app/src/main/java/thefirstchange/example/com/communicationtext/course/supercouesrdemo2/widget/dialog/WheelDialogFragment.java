package thefirstchange.example.com.communicationtext.course.supercouesrdemo2.widget.dialog;
...
import thefirstchange.example.com.communicationtext.course.supercouesrdemo2.base.BaseDialogFragment;
import thefirstchange.example.com.communicationtext.course.supercouesrdemo2.widget.WheelView;
import thefirstchange.example.com.communicationtext.util.ScreenUtil;
...
public class WheelDialogFragment extends BaseDialogFragment implements WheelView.OnValueChangeListener {
    ...
    protected void setSubView() {
        ...
        wheelView.setDividerColor(R.color.Green2);
        wheelView.setSelectedTextColor(R.color.DeepSkyBlue1);
        wheelView.setNormalTextColor(R.color.def_normal);
