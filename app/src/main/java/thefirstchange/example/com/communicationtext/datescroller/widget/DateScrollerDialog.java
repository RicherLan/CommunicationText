...
import thefirstchange.example.com.communicationtext.datescroller.widget.data.WheelCalendar;
...
//        dialog.setContentView(initView()); // 设置View
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.timepicker_layout, null);
        bottomDialog.setContentView(view);
        ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
        params.width = getContext().getResources().getDisplayMetrics().widthPixels - DensityUtiltwo.dp2px(getContext(), 16f);
       // params.bottomMargin = DensityUtiltwo.dp2px(getContext(), 8f);
